...
const MCPRecommendations: React.FC = () => {
  return (
    <section id="ai-recommendations" className="bg-[#f9fafb] z-0 flex w-full flex-col overflow-hidden items-center text-black font-normal text-center px-10 py-24 max-md:max-w-full max-md:px-5">
