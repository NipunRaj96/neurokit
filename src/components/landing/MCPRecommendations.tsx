...
const MCPRecommendations: React.FC = () => {
  return (
    <section id="ai-recommendations" className="bg-[#f9fafb] z-0 w-full py-24 px-10 md:px-8 relative">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        <div className="text-center mb-12">
          <Badge className="w-[200px] text-center mb-6">AI-Powered Discovery</Badge>
          <h2 className="text-4xl md:text-5xl font-semibold leading-tight">
            Smart MCP<br />Recommendations
          </h2>
